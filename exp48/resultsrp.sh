...
printf "%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" "Dataset" "Raw" "Precis" "Recall" "AUC" "RawIB1" "RawIB3" "RawIB5" "RawIB7" "RawIB9" "RecallIB1" "RecallIB3" "RecallIB5" "RecallIB7" "PrecisIB1" "PrecisIB3" "PrecisIB5" "PrecisIB7" "PrecisIB9" "AUCIB1" "AUCIB3" "AUCIB5" "AUCIB7" "AUCIB9" "BAYIB1" #$bay $rp
...
do
  ...
  echo $dataset $bayIB1 $bayIB3 $bayIB5 $bayIB7 $bayIB9
  ...
  rpIB9=`cat $dataset/Results/rp/$dataset\_rp9_raw_avg`
  ...
  # comma separated  
#printf "%s,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n" $dataset $raw $raw_precision $raw_recall $raw_auc $rawIB1 $rawIB3 $rawIB5 $rawIB7 $rawIB9  $precisionIB1 $precisionIB3 $precisionIB5 $precisionIB7 $precisionIB9 $recallIB1 $recallIB3 $recallIB5 $recallIB7 $recallIB9 $aucIB1 $aucIB3 $aucIB5 $aucIB7 $aucIB9 $bayIB1 #$bay $rp
done
